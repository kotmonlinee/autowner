  ...
  return (
    <div className="flex gap-0.5 bg-surface-2 rounded-lg p-1 border border-surface-border">
      {(["popular", "hot", "new"] as const).map(sort => (
        ...
        >
          {sort === "popular" && (
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" width={14} height={14}>
          ...
          {sort === "new" && (
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" width={14} height={14}>
