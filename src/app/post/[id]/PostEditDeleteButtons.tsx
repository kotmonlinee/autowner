    ...
    return (
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          disabled={deleting}
          className="px-2 py-1 bg-red-500 text-white text-[10px] font-bold rounded hover:bg-red-600 transition-colors font-heading disabled:opacity-50"
        >
          {deleting ? "..." : "Yes"}
        </button>
        <button
          ...
          disabled={deleting}
          className="px-2 py-1 bg-surface-3 text-text-secondary text-[10px] font-bold rounded hover:bg-surface-4 transition-colors font-heading"
        >
          No
        </button>
