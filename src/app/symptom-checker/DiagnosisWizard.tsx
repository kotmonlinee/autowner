        ...
        <div>
          ...
          <div className="bg-amber-50/30 dark:bg-amber-950/10 rounded-xl border border-severity-caution-border p-4 mb-6">
            <div className="flex items-start gap-3">
              <TriangleAlert className="w-4 h-4 text-severity-caution shrink-0 mt-0.5" />
              <div>
                <p className="text-xs font-heading font-bold text-severity-caution uppercase tracking-wider mb-1">Disclaimer</p>
