        ...
        <>
          ...
          {otherTags.length > 0 && (mergeOpen ? (
            ...
            <button
              ...
              disabled={loading}
              className="px-3 py-1.5 bg-amber-400/10 text-amber-400 rounded-lg text-xs font-bold hover:bg-amber-400/20 transition-colors font-heading border border-amber-400/20 disabled:opacity-50"
            >
              Merge
            </button>
          ))}
