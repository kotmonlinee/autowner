  ...
  if (isBanned) {
    return (
      <button
        ...
        disabled={loading}
        className="px-3 py-1.5 bg-emerald-600/10 dark:bg-emerald-500/10 text-severity-info rounded-lg text-xs font-bold hover:bg-emerald-600/20 dark:hover:bg-emerald-500/20 transition-colors font-heading border border-emerald-600/20 dark:border-emerald-500/20 disabled:opacity-50"
      >
        {loading ? "..." : "Unban"}
      </button>
    );
