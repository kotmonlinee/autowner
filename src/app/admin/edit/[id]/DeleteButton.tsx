    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={deleting}
          className="px-3 py-2 bg-red-500 text-white text-xs font-bold rounded-lg hover:bg-red-600 transition-colors font-heading disabled:opacity-50"
        >
        ...
        <button
          ...
          disabled={deleting}
          className="px-3 py-2 bg-surface-3 text-text-secondary text-xs font-bold rounded-lg hover:bg-surface-4 transition-colors font-heading disabled:opacity-50"
        >
          Cancel
        </button>
