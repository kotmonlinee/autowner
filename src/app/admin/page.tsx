            ...
            <div className="flex items-center gap-2 ml-4 shrink-0">
              ...
              <form action={async () => {
                ...
                <button className={`px-4 py-2 rounded-lg text-sm font-bold transition-colors font-heading border ${
                  post.is_pinned
                    ? "bg-purple-600/10 dark:bg-purple-500/10 text-purple-600 dark:text-purple-400 border-purple-600/20 dark:border-purple-500/20 hover:bg-purple-600/20 dark:hover:bg-purple-500/20"
